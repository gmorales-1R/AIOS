...
The architect guides the creation and modification of nodes — from a stated need to a well-structured, correctly placed subtree. It is part of the sprout.
...
- Before building anything — the architect defines the shape, then development follows
